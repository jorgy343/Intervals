...
namespace Jorgy.Invervals
{
    ...
    {
        public static readonly MinimumEndpoint<T> Infinity = new MinimumEndpoint<T>(default(T), IntervalExclusivity.Exclusive, true);

        public MinimumEndpoint(T value, IntervalExclusivity exclusivity, bool isInfinity = false)
        {
            Value = value;
        ...
        public int CompareTo(MinimumEndpoint<T> other)
        {
            if (this < other)
                return -1;
        ...
        public bool Equals(MinimumEndpoint<T> other)
        {
            return this == other;
        }
        ...
        public static bool operator ==(MinimumEndpoint<T> left, MinimumEndpoint<T> right)
        {
        ...
        public static bool operator ==(MinimumEndpoint<T> left, MaximumEndpoint<T> right)
        {
            if (left.IsInfinity || right.IsInfinity)
                return false;
